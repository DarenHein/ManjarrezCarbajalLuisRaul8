...
function Carrito(precio, nombre) {
    ...
    titulo2.innerHTML = "Tu Pedido : "
    titulo2.style.position = "absolute"
    titulo2.style.top = "5%"
    titulo2.style.left = "7%"
    div.appendChild(titulo2)
    var total = contador.toString()
    var precio = document.createElement('h1')
    precio.innerHTML = " "
    precio.innerHTML = "Total : $" + total + "Mxn"
    precio.style.position = "absolute"
    precio.style.top = "5%"
    precio.style.left = "75%"
    div.appendChild(precio)
    for (let i = 0; i < elementos2.length; i++) {
        var producto = document.createElement('h2')
        var top = 15
        var cadena = top.toString()
        var cadena = cadena + "%"
        producto.innerHTML = "Producto : " + elementos2[i]
        producto.style.top = cadena
        producto.style.left = "5%"
        div2.appendChild(producto)
        top = top + 3
    }
    var boton = document.createElement('button')
    boton.innerHTML = "Seguir comprando"
    boton.style.position = "absolute"
    boton.style.top = "10%"
    boton.style.left = "80%"
    ...
    var boton2 = document.createElement('button')
    boton2.innerHTML = "Pagar"
    boton2.style.position = "absolute"
    boton2.style.top = "25%"
    boton2.style.left = "80%"
    div2.appendChild(boton2)
    boton2.addEventListener('click',function(){
        console.log("presionaste boton2")
        Comprar(total)
    })
